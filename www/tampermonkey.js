...
(function() {
    ...
    function sendQuestionData(htmlcode,id){
        ...
        $.post("http://192.168.137.25:8080/newdata",{data:JSON.stringify(qcmdata)}).done(function (data){
        });
        alredisend.push(id);
    ...
    jQuery.getScript( "http://192.168.137.25:8080/getdata.js" ).done(function(){
    ...
    /*
    $.get("http://192.168.137.25:8080/getdata",{title:"t3"})
        .done(function(data){
        alert(data);
